...
public class ChoseSnakeController{
  ...
  private void initializeArrays() {
    ...
    snakes[2][2]=new QuestionSnake();
    snakes[2][3]=new QuestionSnake();
    snakes[3][0]=new QuestionSnake();
    snakes[3][1]=new QuestionSnake();
    snakes[3][2]=new QuestionSnake();
    snakes[3][3]=new QuestionSnake();
